...
class HolidaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create holiday" do
    assert_difference('Holiday.count') do
      post holidays_url, params: { holiday: { country: @holiday.country, description: @holiday.description, holiday_date: @holiday.holiday_date, name: @holiday.name, states: @holiday.states } }
    end
  ...
  test "should update holiday" do
    patch holiday_url(@holiday), params: { holiday: { country: @holiday.country, description: @holiday.description, holiday_date: @holiday.holiday_date, name: @holiday.name, states: @holiday.states } }
